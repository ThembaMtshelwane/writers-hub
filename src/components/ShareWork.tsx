  ...
  return (
    <section className="py-3 px-3">
      <div className="bg-white rounded-3xl grid px-4 xl:px-6 md:h-[600px]  md:w-[450px] w-[260px]  lg:w-[600px] pc:w-[1200px] pc:h-[750px] xl:w-[850px] ">
        ...
        <form action="" className="grid grid-cols-1 py-10 2xl:py-5 lg: 2xl:space-x-1 space-y-3 md:grid-cols-2 pc:px-10">
...
/>
<label htmlFor="movie-radio" className="ms-2 text-sm font-medium text-black kobus:text-3xl big:text-5xl">Poem</label>
</div>
<div className="flex items-center me-4 ">
<input
id="movie-radio"
...
className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
/>
<label htmlFor="movie-radio" className="ms-2 text-sm font-medium text-black kobus:text-3xl big:text-5xl">Short story</label>
</div>
<div className="flex items-center me-4">
<input
id="series-radio"
...
className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
/>
<label htmlFor="series-radio" className="ms-2 text-sm font-medium text-black kobus:text-3xl big:text-5xl">long-form</label>
</div>
  </div>
