...
const Rubric: React.FC<RubricProps> = ({ work, onClose }) => {
  return (
    <div className="relative bg-white rounded-md flex flex-col items-center border-2 px-10 pb-10 w-[30rem] mx-auto mb-20 space-b-5">
      ...
      <div className="p-5 border border-black text-2xl w-fit rounded-md">20</div>
      
      {/* Close button */}
      <IoClose onClick={onClose} className="size-6 absolute right-5 top-5 cursor-pointer hover:text-black/50" />
    </div>
  );
};
